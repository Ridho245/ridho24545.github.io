        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('backend/assets/images/ll.jpg') }}" alt="logo-sm" height="22">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('backend/assets/images/ll.jpg') }}" alt="logo-sm-light" height="25">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('backend/assets/images/ll.jpg') }}" alt="logo-light" height="60">
                    </span>
                </a>
            </div>
